...
from nlp_task.path_manager import PathExtraction, PathTranslation, PathSummarization
from nlp_task.ned_dis import CandidateDisambiguation
...
if __name__ == '__main__':
    ...
    input = """Zika belongs to the Flaviviridae virus family and it is spread by Aedes mosquitoes.
               Individuals affected by Zika and other syndromes like the chikungunya fever often experience symptoms like viral myalgia, infectious edema, and infective conjunctivitis.
